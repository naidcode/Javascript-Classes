const username = " Nahid pasha ";
   ...
   Array.from(fruits).forEach(fruit => {  //*and for foreach first we need to make our class to an array after we can use foreach also
...
for(let ul of ulelement){
   ...
   element2.style.color = "white"
      ...
      const h4ele = document.querySelectorAll("h4")

      h4ele[0].style.backgroundColor = "brown"

      h4ele.forEach(h42 => {
        h42.style.backgroundColor = "lightpink"
      })
