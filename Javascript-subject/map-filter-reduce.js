...
number.push(20); //push return new element in array
console.log(number);

let c = number.shift(); //shift remove first element from array
console.log(c);
console.log(number);

let e = number.unshift(100); //add element inthe starting of the array
console.log(e);
console.log(number);
...
console.log(h);
  ...
  //splice we can use to add new element inthe array.
